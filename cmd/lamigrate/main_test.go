...
func TestVersionSubprocess(t *testing.T) {
	...
	if got != "0.1.0-experimental" {
		t.Fatalf("version output = %q, want %q", got, "0.1.0-experimental")
	}
}
...
func TestVersionString(t *testing.T) {
	t.Parallel()
	if version != "0.1.0-experimental" {
		t.Errorf("version = %q, want %q", version, "0.1.0-experimental")
	}
}
